...
echo "   PYTHONPATH=backend python backend/run_producer.py"
echo ""
echo "2. Start the consumer (in another terminal):"
echo "   source .venv/bin/activate"
echo "   PYTHONPATH=backend python backend/run_consumer.py"
echo ""
echo "3. Start the API server (in another terminal):"
echo "   source .venv/bin/activate"
echo "   PYTHONPATH=backend python backend/main.py"
echo ""
